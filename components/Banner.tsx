...
const Banner = () => (
  <div className="flex justify-center items-center bg-[color:#4686C1] w-screen h-full md:h-[60vh]">
    <div className="flex flex-col md:flex-row justify-between items-center w-screen sm:w-[80vw] h-auto md:h-5/6 bg-white max-w-screen-lg sm:rounded-lg overflow-hidden shadow-2xl">
