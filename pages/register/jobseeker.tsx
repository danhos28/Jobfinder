  ...
  return (
    <Layout title="Jobfinder: Register">
      ...
      <div className="flex justify-center items-center w-screen h-screen bg-gray-100">
        <div className="flex flex-col items-center mt-60px bg-white sm:rounded-lg sm:shadow-md px-10 sm:px-14 lg:px-16 xl:px-20 2xl:px-28 2xl:py-20 py-14 h-3/4 min-h-[500px] max-h-[700px] sm:w-[60vw] md:w-[50vw] lg:w-[40vw]">
